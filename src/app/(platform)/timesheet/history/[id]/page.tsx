...
export default function TimesheetDetailPage() {
  ...
  useEffect(() => {
    ...
    router.replace(`/timesheet?ts=${id}&print=1`);
      ...
      <PageHeader
        action={
          <div className="flex gap-2 items-center">
            ...
            <Button size="sm" variant="secondary" icon={<Printer size={13}/>} onClick={() => window.open(`/timesheet?ts=${id}&print=1`, '_blank', 'noopener,noreferrer')}>Print</Button>
